/********************************************************************************
** Form generated from reading UI file 'dynamixel_gui.ui'
**
...
#ifndef UI_DYNAMIXEL_GUI_H
#define UI_DYNAMIXEL_GUI_H
...
public:
    ...
    void setupUi(QWidget *DynamixelGUIWidget)
    {
        if (DynamixelGUIWidget->objectName().isEmpty())
            DynamixelGUIWidget->setObjectName(QStringLiteral("DynamixelGUIWidget"));
        DynamixelGUIWidget->setEnabled(true);
        DynamixelGUIWidget->resize(425, 300);
        verticalLayout = new QVBoxLayout(DynamixelGUIWidget);
        verticalLayout->setObjectName(QStringLiteral("verticalLayout"));
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        toolbar_widget = new QWidget(DynamixelGUIWidget);
        ...
        scrollArea = new QScrollArea(DynamixelGUIWidget);
        scrollArea->setObjectName(QStringLiteral("scrollArea"));
        scrollArea->setFrameShape(QFrame::NoFrame);
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QStringLiteral("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 423, 213));
        ...
        retranslateUi(DynamixelGUIWidget);

        QMetaObject::connectSlotsByName(DynamixelGUIWidget);
    } // setupUi

    void retranslateUi(QWidget *DynamixelGUIWidget)
    {
        DynamixelGUIWidget->setWindowTitle(QApplication::translate("DynamixelGUIWidget", "Image View", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        refresh_topics_push_button->setToolTip(QApplication::translate("DynamixelGUIWidget", "Refresh topics", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        zoom_1_push_button->setToolTip(QApplication::translate("DynamixelGUIWidget", "Original zoom", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        num_gridlines_spin_box->setToolTip(QApplication::translate("DynamixelGUIWidget", "# of gridlines to overlay", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        dynamic_range_check_box->setToolTip(QApplication::translate("DynamixelGUIWidget", "Dynamic depth range", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        dynamic_range_check_box->setText(QString());
#ifndef QT_NO_TOOLTIP
        max_range_double_spin_box->setToolTip(QApplication::translate("DynamixelGUIWidget", "Max depth", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        max_range_double_spin_box->setSuffix(QApplication::translate("DynamixelGUIWidget", "m", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        save_as_image_push_button->setToolTip(QApplication::translate("DynamixelGUIWidget", "Save as image", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        publish_click_location_check_box->setText(QString());
#ifndef QT_NO_TOOLTIP
        publish_click_location_topic_line_edit->setToolTip(QApplication::translate("DynamixelGUIWidget", "Click location topic (leave empty for auto-naming)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        smooth_image_check_box->setToolTip(QApplication::translate("DynamixelGUIWidget", "Dynamic depth range", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        smooth_image_check_box->setText(QApplication::translate("DynamixelGUIWidget", "Smooth scaling", Q_NULLPTR));
        rotate_left_push_button->setText(QString());
        rotate_label->setText(QApplication::translate("DynamixelGUIWidget", "0\302\260", Q_NULLPTR));
...
namespace Ui {
    class DynamixelGUIWidget: public Ui_DynamixelGUIWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DYNAMIXEL_GUI_H
